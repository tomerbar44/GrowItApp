...
const {
  initSystem,
  addToMyPlants,
  irrigatePlantAndUpdate,
  removeFromDevice,
  setPlantList
} = require('../src/redux/actions/plantActions');
const {
  INIT_SYS,
  ADD_PLANT_TO_LIST,
  SET_MY_PLANTS_LIST,
  SET_PLANTS_LIST
} = require('../src/redux/actions/plantsTypes');
...
describe('plant Action Test', function () {
  test('addToMyPlants', function () {
    ...
    expect(store.getActions()).toEqual(
      expect.arrayContaining([expect.objectContaining({ plant: onePlant })])
    );
  });
